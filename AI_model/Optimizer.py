...
# Load data
df23 = pd.read_csv('/content/Exploring Food Waste Data-2023.csv')
df24 = pd.read_csv('/content/Exploring Food Waste Data-timeseries.csv')
df41 = pd.read_csv('/content/Global Food Security Index 2019.csv', header = 1)
df42 = pd.read_csv('/content/Global Food Security Index 2022.csv')
